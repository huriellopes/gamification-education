...
<template>
    <div
        class="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 backdrop-blur-xl"
    >
        ...
        <ul v-else class="divide-y divide-zinc-800/50">
            <li
                v-for="user in users"
                :key="user.position"
                class="flex items-center justify-between rounded-lg px-2 py-3 transition-colors duration-150 hover:bg-zinc-800/20"
            >
                <div class="flex items-center gap-3">
                    ...
                    >
                        <span
                            ...
                            class="flex h-6 w-6 items-center justify-center rounded-full border border-yellow-500/30 bg-yellow-500/10 text-yellow-400 shadow-[0_0_10px_rgba(234,179,8,0.1)]"
                            >🥇</span
                        >
                        <span
                            v-else-if="user.position === 2"
                            class="flex h-6 w-6 items-center justify-center rounded-full border border-zinc-400/30 bg-zinc-400/10 text-zinc-300"
                            >🥈</span
                        >
                        <span
                            v-else-if="user.position === 3"
