        ...
        >
            ...
            <div class="flex items-center gap-4">
                <button
                    ...
                    class="inline-flex items-center justify-center rounded-xl bg-linear-to-r from-indigo-600 to-violet-600 px-5 py-2.5 text-sm font-bold text-white transition-all hover:brightness-110 disabled:opacity-50"
                >
                    {{
                        form.processing
                            ? __('common.saving')
