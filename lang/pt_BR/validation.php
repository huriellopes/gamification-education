...
return [
    ...
    'encoding' => 'O campo :attribute deve ter uma codificação válida.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute informado apareceu em um vazamento de dados. Escolha um :attribute diferente.',
    ],
    ...
    'attributes' => [
        ...
        'code' => 'código',
        'content' => 'conteúdo',
        'correct_option_index' => 'alternativa correta',
        ...
        'phones' => 'telefones',
        'points_reward' => 'pontos de recompensa',
