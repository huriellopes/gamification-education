...
'sitemap.guzzle_options','sitemap.execute_javascript','sitemap.chrome_binary_path','sitemap.crawl_profile','debugbar.enabled',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','data.date_format','data.date_timezone',
...
'super-admin.users.toggle','super-admin.users.destroy','super-admin.trash.index','super-admin.deleted-models.restore','super-admin.impersonate',
'super-admin.reports.index','super-admin.reports.members','super-admin.reports.performance','super-admin.subjects.index','super-admin.subjects.store',
'super-admin.subjects.update','super-admin.subjects.toggle','super-admin.subjects.destroy','super-admin.classrooms.index','super-admin.classrooms.store',
'super-admin.classrooms.update','super-admin.classrooms.destroy','super-admin.classrooms.toggle','super-admin.logs.index','super-admin.logs.prune',
...
'admin.users.index','admin.users.store','admin.users.update','admin.users.toggle','admin.users.destroy',
'admin.reports.performance','teacher.dashboard','teacher.classrooms.index','teacher.subjects.index','teacher.subjects.show',
'teacher.subjects.generate','teacher.subjects.store','teacher.subjects.update','teacher.subjects.destroy','teacher.materials.store',
'teacher.materials.update','teacher.materials.destroy','teacher.tests.store','teacher.tests.update','teacher.tests.destroy',
'teacher.questions.store','teacher.questions.update','teacher.questions.destroy','teacher.students.index','teacher.students.store',
'teacher.students.update','teacher.students.destroy','teacher.students.toggle','teacher.students.performance','student.dashboard',
'student.subjects.show','student.materials.show','student.materials.complete','student.tests.show','student.tests.submit',
'profile.edit','profile.update','profile.destroy','ranking.index','support.index',
...
'classrooms.action_deactivate','misc.ranking.head_title','misc.ranking.header','misc.ranking.tab_global','misc.ranking.tab_institution',
...
'misc.subject.access_track','misc.confirm.title','misc.confirm.message','nav.aria.main_nav','nav.aria.sidebar_nav',
...
'nav.aria.xp_ranking','nav.aria.tech_support','nav.aria.logout','nav.aria.profile_settings','nav.sidebar.dashboard',
'nav.sidebar.institutions','nav.sidebar.users','nav.sidebar.subjects','nav.sidebar.reports','nav.sidebar.logs_queue',
'nav.sidebar.support','nav.sidebar.site_visits','nav.sidebar.trash','nav.sidebar.members','nav.sidebar.classrooms',
'nav.sidebar.my_classrooms','nav.sidebar.students','nav.sidebar.ranking','nav.sidebar.tech_support','nav.tooltip.classrooms',
'nav.tooltip.my_classrooms','nav.tooltip.students','nav.tooltip.dashboard','nav.tooltip.institutions','nav.tooltip.users',
'nav.tooltip.subjects','nav.tooltip.reports','nav.tooltip.logs_queue','nav.tooltip.support_tickets','nav.tooltip.site_visits',
'nav.tooltip.trash','nav.tooltip.members','nav.tooltip.ranking','nav.tooltip.tech_support','nav.tooltip.my_profile',
'nav.tooltip.logout','nav.navbar.go_public_site_title','nav.navbar.go_public_site','nav.navbar.switch_unit','nav.navbar.settings_profile',
'nav.navbar.my_profile','nav.navbar.logout','nav.impersonation.banner','nav.impersonation.leave','nav.breadcrumb.home',
'nav.breadcrumb.super_admin','nav.breadcrumb.general_panel','nav.breadcrumb.institutions','nav.breadcrumb.users','nav.breadcrumb.subjects',
'nav.breadcrumb.trash','nav.breadcrumb.reports','nav.breadcrumb.logs_queue','nav.breadcrumb.support','nav.breadcrumb.site_visits',
'nav.breadcrumb.admin','nav.breadcrumb.institution_panel','nav.breadcrumb.members','nav.breadcrumb.teacher','nav.breadcrumb.my_subjects',
'nav.breadcrumb.panel','nav.breadcrumb.classrooms','nav.breadcrumb.students','nav.breadcrumb.student','nav.breadcrumb.my_panel',
'nav.breadcrumb.material','nav.breadcrumb.test','nav.breadcrumb.competition','nav.breadcrumb.global_ranking','nav.breadcrumb.tech_support',
'nav.breadcrumb.user','nav.breadcrumb.profile_settings','nav.breadcrumb.dashboard','student.dashboard.title','student.dashboard.greeting',
'student.dashboard.no_institution','student.dashboard.level','student.dashboard.accumulate_hint','student.dashboard.level_progress','student.dashboard.xp_count',
'student.dashboard.my_tracks','student.dashboard.subjects_available','student.dashboard.no_subjects','student.dashboard.points_history','student.dashboard.no_history',
'student.subject.learning_track','student.subject.syllabus','student.subject.no_description','student.subject.your_journey','student.subject.step_reading',
'student.subject.read','student.subject.reward_points','student.subject.review_material','student.subject.start_reading','student.subject.graded_challenge',
'student.subject.completed_max_score','student.subject.last_performance','student.subject.correct_answers','student.subject.xp_received','student.subject.xp_received_value',
'student.subject.retake_challenge','student.subject.take_challenge','student.subject.empty','student.material.track','student.material.learning_actions',
'student.material.reading_reward','student.material.reward_xp','student.material.already_completed','student.material.mark_as_read','student.test.activity_status',
'student.test.instruction','student.test.answered','student.test.answered_count','student.test.question','student.test.graded_challenge',
'student.test.max_reward','student.test.reward_xp','student.test.submit','student.test.confirm_incomplete','superadmin.dashboard.head_title',
'superadmin.dashboard.header','superadmin.dashboard.card_institutions','superadmin.dashboard.card_active_students','superadmin.dashboard.card_total_xp','superadmin.dashboard.card_active_subjects',
'superadmin.dashboard.manage_institutions','superadmin.dashboard.view_users','superadmin.dashboard.global_xp','superadmin.dashboard.manage_subjects','superadmin.dashboard.performance_title',
'superadmin.dashboard.performance_subtitle','superadmin.dashboard.performance_tooltip_label','superadmin.dashboard.xp_suffix','superadmin.dashboard.visits_title','superadmin.dashboard.visits_subtitle',
'superadmin.dashboard.visits_tooltip_label','superadmin.dashboard.visits_suffix','superadmin.users.head_title','superadmin.users.header','superadmin.users.register',
'superadmin.users.search_placeholder','superadmin.users.col_name_email','superadmin.users.col_role','superadmin.users.col_institution','superadmin.users.col_xp',
'superadmin.users.col_last_login','superadmin.users.none','superadmin.users.active','superadmin.users.inactive','superadmin.users.tooltip_impersonate',
'superadmin.users.tooltip_deactivate','superadmin.users.tooltip_activate','superadmin.users.tooltip_edit','superadmin.users.tooltip_delete','superadmin.users.modal_edit_title',
'superadmin.users.modal_new_title','superadmin.users.label_full_name','superadmin.users.label_email','superadmin.users.label_password','superadmin.users.label_password_keep',
'superadmin.users.label_role','superadmin.users.option_student','superadmin.users.option_teacher','superadmin.users.option_admin','superadmin.users.label_institution',
'superadmin.users.select_institution','superadmin.users.label_associate_institutions','superadmin.users.saving','superadmin.users.save_user','superadmin.users.role_super_admin',
'superadmin.users.role_admin','superadmin.users.role_teacher','superadmin.users.role_student','superadmin.users.never_logged_in','superadmin.users.invalid_date',
'superadmin.users.confirm_status_title','superadmin.users.confirm_status_message','superadmin.users.action_deactivate','superadmin.users.action_activate','superadmin.users.confirm_delete_title',
'superadmin.users.confirm_delete_message','superadmin.users.confirm_impersonate_title','superadmin.users.confirm_impersonate_message','superadmin.institutions.head_title','superadmin.institutions.header',
...
'superadmin.reports.download_title','superadmin.reports.download','superadmin.reports.processing_ellipsis','superadmin.reports.invalid_date','teacher.dashboard.title',
...
'teacher.subject_show.ai_input_placeholder','teacher.subject_show.ai_generating','teacher.subject_show.ai_generate','teacher.subject_show.materials_title','teacher.subject_show.tests_title',
...
'ui.common.view','ui.common.details','ui.common.all','ui.common.loading','ui.common.no_results',
'ui.common.confirm_delete','ui.common.name','ui.common.email','ui.common.description','ui.common.back',
...
'ui.auth.resend_verification','ui.auth.logout','ui.greeting.morning','ui.greeting.afternoon','ui.greeting.evening',
'ui.greeting.hello','ui.greeting.msg_super_admin','ui.greeting.msg_admin','ui.greeting.msg_teacher','ui.greeting.msg_student',
'ui.welcome.nav.go_dashboard','ui.welcome.nav.login','ui.welcome.nav.create_account','ui.welcome.hero.badge','ui.welcome.hero.title',
'ui.welcome.hero.title_highlight','ui.welcome.hero.description','ui.welcome.hero.access_panel','ui.welcome.hero.start_now','ui.welcome.hero.magic_login',
'ui.welcome.mockup.progress','ui.welcome.mockup.level','ui.welcome.mockup.level_hint','ui.welcome.mockup.top_students','ui.welcome.mockup.subject_in_progress',
'ui.welcome.mockup.subject_title','ui.welcome.mockup.subject_desc','ui.welcome.mockup.material_read','ui.welcome.features.tracks_title','ui.welcome.features.tracks_desc',
'ui.welcome.features.gamification_title','ui.welcome.features.gamification_desc','ui.welcome.features.rankings_title','ui.welcome.features.rankings_desc','ui.welcome.features.passwordless_title',
'ui.welcome.features.passwordless_desc','ui.welcome.stats.active_students','ui.welcome.stats.subjects_offered','ui.welcome.stats.xp_earned','ui.welcome.stats.online_responsive',
'ui.welcome.footer','ui.welcome.cookie.title','ui.welcome.cookie.body','ui.welcome.cookie.decline','ui.welcome.cookie.accept',
'ui.profile.title','ui.profile.subtitle','ui.profile.info_title','ui.profile.info_subtitle','ui.profile.name',
'ui.profile.email','ui.profile.email_unverified','ui.profile.resend_verification_link','ui.profile.verification_sent','ui.profile.password_title',
'ui.profile.password_subtitle','ui.profile.current_password','ui.profile.new_password','ui.profile.confirm_password','ui.profile.delete_title',
'ui.profile.delete_subtitle','ui.profile.delete_button','ui.profile.delete_confirm_title','ui.profile.delete_confirm_subtitle','ui.profile.password',
'messages.role_super_admin','messages.role_admin','messages.role_teacher','messages.role_student','messages.status_active',
'messages.status_inactive','messages.user_created','messages.user_updated','messages.user_status_toggled','messages.user_deleted',
'messages.user_restored','messages.institution_created','messages.institution_updated','messages.institution_status_toggled','messages.institution_deleted',
'messages.institution_restored','messages.content_generation_queued','messages.report_generation_queued','messages.subject_created','messages.subject_updated',
'messages.subject_deleted',);
